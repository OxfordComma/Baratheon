...
public class LoginHandler : MonoBehaviour {
	...
	public void Login()
	{
		...
		if (!users.Contains(nameInLoginField))
			...
			playerHandler.currentPlayer = Player.Load(Path.Combine(Application.persistentDataPath, "users/" + nameInLoginField + "/player.xml"));
	...
	public void CreateLogin(string username)
	{
		...
		newPlayer.SaveToXML ();
        playerHandler.currentPlayer = newPlayer;
    }
}
